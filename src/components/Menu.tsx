...
const Menu: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            <div className="md:hidden mt-2" data-testid="menu-mobile">
            ...
            <div className="hidden md:block space-y-[60px]" data-testid="menu-desktop">
                ...
                {(activeCategory === 'all' || activeCategory === 'gyros') && gyrosItems.length > 0 && (
                    <div className="relative">
                         <div className="relative w-full bg-hero-green rounded-[80px] pb-[30px] pt-[200px] px-[30px] shadow-xl mt-[190px]">
