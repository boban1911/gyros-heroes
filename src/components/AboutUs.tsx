    ...
    <section id="o-nama" className="relative w-full bg-hero-blue py-[60px] md:py-[100px] flex flex-col items-center gap-[60px] overflow-hidden">
      ...
      <div className="relative w-full max-w-[1240px] px-4">
        ...
        <div className="xl:hidden flex flex-col items-center gap-10">
           ...
           {/* Cards Stack */}
           <div className="flex flex-col gap-6 w-full max-w-[500px] -mt-12 md:-mt-16 z-10 relative">
             {cards.map((card, idx) => (
                <div key={idx} className={`bg-hero-green rounded-[40px] p-6 md:p-8 flex flex-col gap-3 shadow-lg ${idx === 0 ? 'pt-[70px] md:pt-[100px]' : ''}`}>
