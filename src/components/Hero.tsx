            ...
            <div className="flex flex-col gap-12 w-full max-w-4xl">
                ...
                <div className="flex flex-col items-center gap-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <a href="https://glovoapp.com/rs/sr/nis/gyros-heroes-nis/" target="_blank" rel="noopener noreferrer" className="bg-hero-yellow text-grey-black font-montserrat text-[14px] h-[44px] md:h-[60px] px-8 flex items-center justify-center rounded-full shadow-hero-xs hover:bg-white hover:text-hero-yellow transition-colors duration-300">
                            <span className="font-medium">Poruči i pokupi</span><span className="font-bold"> - CENTAR</span>
                        </a>
                        <a href="https://wolt.com/sr/srb/nis/restaurant/gyros-heroes-nis" target="_blank" rel="noopener noreferrer" className="bg-hero-yellow text-grey-black font-montserrat text-[14px] h-[44px] md:h-[60px] px-8 flex items-center justify-center rounded-full shadow-hero-xs hover:bg-white hover:text-hero-yellow transition-colors duration-300">
                ...
                <div className="flex flex-col items-center gap-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <a href="https://wolt.com/sr/srb/novi-sad/restaurant/gyros-heroes-ns" target="_blank" rel="noopener noreferrer" className="bg-hero-yellow text-grey-black font-montserrat text-[14px] h-[44px] md:h-[60px] px-8 flex items-center justify-center rounded-full shadow-hero-xs hover:bg-white hover:text-hero-yellow transition-colors duration-300">
