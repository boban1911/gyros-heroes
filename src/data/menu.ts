import classicHeroImg from '../assets/menu/classic-hero.png';
import pomfritImg from '../assets/menu/pomfrit.png';
import heroPomfritImg from '../assets/menu/hero-pomfrit.png';
import pomfritCheddarImg from '../assets/menu/pomfrit-cheddar.png';
import pomfritCheddarSlaninaImg from '../assets/menu/pomfrit-cheddar-slanina.png';
import superHeroImg from '../assets/menu/super-hero.png';
import heroTortillaImg from '../assets/menu/hero-tortilla.png';
import chickenHeroNuggetsImg from '../assets/menu/chicken-hero-nuggets.png';
import pohovaniHeroImg from '../assets/menu/pohovani-hero.png';
import chickenHeroNuggetsBoxImg from '../assets/menu/chicken-hero-nuggets-box.png';
import chickenHeroWrapImg from '../assets/menu/chicken-hero-wrap.png';
import kidsHeroObrokImg from '../assets/menu/kids-hero-obrok.png';
import platterBaseImg from '../assets/menu/platter-base.png';
import heroFullObrokMeatImg from '../assets/menu/hero-full-obrok-meat.png';
import vegeHeroToppingImg from '../assets/menu/vege-hero-topping.png';
